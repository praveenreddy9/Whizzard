                                                ...
                                                showsHorizontalScrollIndicator={true}>
                                                {
                                                    this.state.clientUserIdList.length === 0
                                                        ...
                                                        <ScrollView
                                                            ...
                                                            {
                                                                this.state.clientUserIdList.map((item, index) => {
                                                                    return (
                                                                        <View key={index}>
                                    ...
                                    <View
                                        ...
                                        <Card style={[Styles.p10]}>
                                            ...
                                            <Card.Title
                                                        ...
                                                        style={[Styles.marV5, Styles.bcLYellow, Styles.bw1, Styles.bgWhite]}
                                                        title={<Text>
                                                            Expected Shift Duration <Text style={[Styles.ffMbold,Styles.f18]}>{this.state.UpdateShiftDetails.attributes.expectedDuration}</Text>
                                                        </Text>}
                                                ...
                                                <ScrollView
                                                    ...
                                                    style={[{height: this.state.SupervisorDetails.length === 1 ? 80 : this.state.SupervisorDetails.length === 2 ? 165 : Dimensions.get('window').height / 2.5}]}>
                                                    {
                                                        this.state.SupervisorDetails.map((item, index) => {
                                                            return (
                                                                <View key={index}>
                                                                    {Services.getSupervisorList(item)}
                                                                </View>
                                                            )
                                                        })
                                                    }
