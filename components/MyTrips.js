            ...
            <View style={[Styles.bcAsh, {marginBottom: 15}]}>
                <View style={[{backgroundColor: '#fff'}, Styles.row, Styles.jSpaceBet, Styles.alignCenter]}>
                    <View style={[Styles.flex1]}>
                        <CText
                            cStyle={[styles.dHistoryGridSub,Styles.ffMbold, {fontSize: 16}]}>{item.shiftDateStr || '-------'}</CText>
                        <CText cStyle={[Styles.ffMregular,Styles.f14,Styles.txtAlignCen]}>
                    ...
                    <TouchableOpacity style={[Styles.txtAlignRt]}
                        ...
                        <Text style={[Styles.ffMregular,Styles.p20]}>
                                        ...
                                        <View style={{margin: 5}}>
                                            <View style={{padding: 10}}>
                                                <View style={[Styles.row, Styles.jSpaceBet, {fontSize: 20}]}>
                                                    <Text style={[Styles.f20,Styles.ffMbold,Styles.cBlk]}>Summary</Text>
                                                        ...
                                                        <View style={{marginTop: 5, marginBottom: 5}}>
                                                            ...
                                                            <View
                                                                ...
                                                                <Card
                                                                    ...
                                                                    <Card.Content>
                                                                        <Title style={[Styles.f18,Styles.txtAlignCen,Styles.ffMbold]}>{this.state.deliveriesData.startOdometerReading}</Title>
                                                                    </Card.Content>
                                                                ...
                                                                <Card
                                                                    ...
                                                                    <Card.Content>
                                                                        <Title style={[Styles.f18,Styles.txtAlignCen,Styles.ffMbold]}>{this.state.deliveriesData.endOdometerReading}</Title>
                                                                    </Card.Content>
                                                                </Card>
                                                        ...
                                                        <TouchableOpacity
                                                            ...
                                                            <Card
                                                                ...
                                                                <Card.Content
                                                                    ...
                                                                    <Title></Title>
                                                                    <Title style={[Styles.f18,Styles.ffMbold]}>{this.state.deliveriesData.totalDeliveries}/{this.state.deliveriesData.totalPackages}</Title>
                                                                    <Title><MaterialIcons
