    ...
    async requestBackgroundPermission(){
        try {
            const granted = request(Platform.OS === 'ios' ?
                ...
                PERMISSIONS.ANDROID.ACCESS_BACKGROUND_LOCATION).then((result) => {
                if ('granted' === result){
                        ...
                        this.state.granted && this.state.QRVisible === true
                            ...
                            <View style={[Styles.flex1, Styles.bgWhite]}>
                                <Appbar.Header style={[Styles.bgWhite]}>
                                    ...
                                    <Appbar.Content title="Attendance Log"/>
                        ...
                        this.state.currentShift
                            ...
                            <View style={[Styles.flex1, Styles.bgWhite]}>
                                ...
                                <View style={[Styles.bgWhite]}>
                                    <CText
                                        cStyle={[Styles.f18, Styles.marH20, Styles.marV10,Styles.ffMregular]}>Mark
                                        Your attendance at <CText
                                            cStyle={[Styles.f18, Styles.marV5,Styles.ffMbold]}>{this.state.siteLocation}({this.state.siteCode})</CText></CText>
                                </View>
                                {
                                    this.state.granted && this.state.QRVisible === true
                                        ?
