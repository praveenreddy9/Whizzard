            ...
            <TouchableOpacity onLongPress={() => Utils.dialogBox(item.clientUserId, '')}
                ...
                <Card style={[styles.shadow, Styles.marV5]}>
                    <Card.Title
                                ...
                                style={[Styles.bcLYellow, Styles.bw1, Styles.bgWhite,Styles.ffMregular]}
                                        ...
                                        <ScrollView style={[Styles.padH10]}>
                                            ...
                                            <Card.Content style={[Styles.aslCenter, Styles.padV15]}>
                                                <Title style={[Styles.cBlk, Styles.f16, Styles.ffMregular]}>SEARCH <Text
                                                    style={[Styles.ffMbold]}>EXISTING</Text> USER
                                                    ID's</Title>
                                            </Card.Content>
                                            {/*SEARCH BOX*/}
                                            <View style={[Styles.alignCenter, Styles.marV5]}>
                                                <Input
                                                    style={[Styles.ffMbold,{
                                                        height: 50,
                                                        width: 250,
                                                        borderWidth: 1,
                                                        borderRadius: 50,
                                                ...
                                                showsHorizontalScrollIndicator={true}>
                                                {
                                                    this.state.clientUserIdList.length === 0
                                                        ...
                                                        <ScrollView
                                                            ...
                                                            {
                                                                this.state.clientUserIdList.map((item)=>{
                                                                    return(
                                                                        <View key={index}>
                                                                            {this.clientUserIdSelect(item)}
                                                                        </View>
                                                                    )
                                                                })
                                                            }
                                            ...
                                            <View style={[Styles.padV10]}>
                                                <View style={[Styles.row, Styles.jSpaceBet]}>
                                                    <Title
                                                        ...
                                                        style={[Styles.ffMbold]}>NEW</Text> USER
                                                        ID</Title>
                                        ...
                                        <View style={[Styles.p10]}>
                                            ...
                                            <Card style={[styles.shadow, Styles.marV5]}>
                                                <Card.Title
                                                            ...
                                                            title={<CText
                                                                ...
                                                                Attendance at
                                                                <CText
                                                                    cStyle={[Styles.padV3, Styles.aslStart, Styles.cBlk, Styles.f18,Styles.ffMbold]}> {new Date(CompletedShiftDetails.reportingTime).getHours()}:{new Date(CompletedShiftDetails.reportingTime).getMinutes()}</CText></CText>}
                                            ...
                                            <Card style={[styles.shadow, Styles.marV5]}>
                                                <Card.Title
                                                            ...
                                                            title={
                                                                <Text>
                                                                    Expected Shift Duration <Text style={[Styles.ffMbold,Styles.f18]}>{this.state.CompletedShiftDetails.attributes.expectedDuration}</Text>
                                                                </Text>
                                                            }
                                                ...
                                                <ScrollView
                                                    ...
                                                    style={[Styles.flex1]}>
                                                    {
                                                        this.state.pickUpPackagesInfo.length === 0
                                                            ...
                                                            :
                                                        this.state.pickUpPackagesInfo.map((item,index)=>{
                                                            return(
                                                                <View key={index}>
