...
const theme = {
  ...DefaultTheme,
  fonts: {
    medium: Styles.ffMregular,
    regular:Styles.ffMbold,
  },
};
        ...
        <View
          ...
          <View style={Styles.alignCenter}>
            {this.state.ErrorMessage ? (
              ...
              <Text
                style={[Styles.ffMbold,Styles.padH10,Styles.f18
                ]}>
                "Something went wrong! Please try again1222"
              </Text>
            )}
          </View>
          <View style={[Styles.alignCenter]}>
