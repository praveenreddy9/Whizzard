...
const routes = {
    ...
    // BASE_URL: "http://192.168.29.159:8090",  //Jeevan IP TECH
    // BASE_URL: "http://192.168.0.113:8090",  //Jeevan IP TECH#2
    // BASE_URL: "http://192.168.29.159:8090",  //Jeevan IP 2.4
    // BASE_URL: "http://192.168.29.54:8090",  //SAI IP
    // BASE_URL: "http://192.168.29.224:8090",  //SAI OFFICE IP TECH
    // BASE_URL: "http://192.168.0.112:8090",  //SAI OFFICE IP Tech#2
    ...
    Android_URL:"http://testing.whizzard.in",
    IOS_URL:"https://testing.whizzard.in",


    BASE_URL: Platform.OS === 'ios' ? "https://testing.whizzard.in" : "http://testing.whizzard.in",   //NEW testing URL (13.233.126.214==>new IP)
    // BASE_URL: "http://mobileapi.whizzard.in",  // New Server live URL

    // BASE_URL: "http://mllapi.whizzard.in",  // New MLL Server URL
    ...
    imageSelectionFromGallery:false,  //start,EndShift,Lite User screens
    ...
    UPLOAD_VERIFICATION_VEHICLE_SHIFT_IMAGE :'/api/v1/tripSummary/uploadVerificationVehicleImage?',
    ...
    GET_CANCELLED_SHIFTS: '/api/v1/userShift/getCancelledShiftsForUser',   //not using
    ...
    UPLOAD_SHIFT_VEHICLE_PIC : "/api/v1/userShift/uploadAdhocShiftVehicleImage?",
    ...
    GET_VEHICLE_DETAILS_NUMBER_BASED : "/api/v1/vehicle/getVehicleByRegistrationNumber/",  //jeevan given
    ...
    SEND_OTP_TO_DELIVER: '/api/v1/orders/sendOTP/', //sai Given
    VERIFY_OTP_TO_DELIVER: '/api/v1/orders/verifyOTP/', //sai Given
    CUSTOMER_DIGITAL_SIGNATURE: '/api/v1/orders/uploadDigitalSignature?id=', //sai Given   //customers sign during delivery //optional
    UPLOAD_DELIVERED_MULTIPLE_IMAGES: '/api/v1/orders/uploadImages?id=',     //sai Given   //to upload multiple images FormData
    ...
    //NODE API's
    GET_SHIFT_LOCATIONS:'/api/v1/userLocations/getUserShiftLocations/',   //trip view API
    SAVE_SHIFT_LOCATIONS:"/api/v1/userLocations/saveUserShiftLocations",    //to save location from Network Util
    GET_SHIFT_DISTANCE :'/api/v1/userLocations/getCalculatedShiftDistance/'  //returns distance calculated  //should not use in mobile
