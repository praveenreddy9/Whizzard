                    ...
                    <SafeAreaView style={[Styles.flex1]}
                        ...
                        <TouchableOpacity onPress={() => {
                            ...
                            <Card.Title title="Menu"
                                        style={{height:50}}
                                        titleStyle={[Styles.ffMregular,Styles.f16,Styles.pLeft15]}
                        ...
                        <ScrollView style={[Styles.flex1]}>
                            <TouchableOpacity onPress={() => {
                                ...
                                <Card.Title
                                    title="Home"
                                    style={{height:60}}
                                    titleStyle={[Styles.ffMbold,Styles.f16,Styles.pLeft15]}
                            ...
                            <TouchableOpacity onPress={() => {
                                ...
                                <Card.Title
                                    title="Settings"
                                    style={{height:60}}
                                    titleStyle={[Styles.ffMregular,Styles.f16,Styles.pLeft15]}                                    left={() => <List.Icon icon="settings" color={"#000"}/>}
                                    // right={() => <List.Icon icon="chevron-right" />}
                                />
                            </TouchableOpacity>
                            <Divider style={{height:0.5}}/>
