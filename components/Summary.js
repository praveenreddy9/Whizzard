    ...
    Associate_AttResp_Pickup() {
        ...
        return (
            ...
            <View style={{padding: 10}}>
                ...
                <View>
                    <FlatList
                        data={AttendenceResponse.ordersStatusCount}
                        renderItem={({item}) => this.PackagesList(item.count,item.status)}
                ...
                <View style={{padding: 10}}>
                    ...
                    <View>
                        <FlatList
                            data={AttendenceResponse.pickUpPackagesInfo}
                            renderItem={({item}) => this.PackagesList(item.count,item.type)}
                            extraData={this.state}
                            keyExtractor={(item, index) => index.toString()}/>
                    </View>
                </View>
                            ...
                            <ScrollView
                                ...
                                </TouchableOpacity>
                                {
                                    item.statuses.length > 0
                                        ?
                                        item.statuses.map((data) => {
                                            return(
                                                <View style={[Styles.row, Styles.jSpaceArd,Styles.brdrBtm1,Styles.p3]}>
                                                    <Text
