...
export default class OrdersListScreen extends React.Component {
    ...
    constructor(props) {
        ...
        this.state = {
            ...
            rejectReason:'',errorRejectReason:null,rejectReasonModal:false,selectedChip: '',selectedChipName:'',
            chipsList: [
                ...
                {status: 'REJECTED_BY_DA', name: 'DA Rejected', value: 8},
                {status: 'REJECTED_BY_CUSTOMER', name: 'Customer Rejected', value: 9},
    ...
    render() {
        const {ordersList,selectedChip,selectedChipName} = this.state
        const br = `\n`;
        return (
            <View style={[[Styles.flex1, Styles.bgWhite]]}>
                ...
                <View style={[Styles.bgLBlueAsh, Styles.AuthScreenHeadershadow]}>
                    <Appbar.Header style={Styles.bgDarkRed}>
                        ...
                        <Appbar.Content title={(selectedChip === '' ? 'All Orders' : selectedChipName)+ (ordersList.length > 0 ? ' ('+ordersList.length+')': '') } titleStyle={[Styles.ffMextrabold,Styles.cWhite]}/>
                        ...
                        {this.state.chipsList.map((item, index) => {
                            return (
                                <TouchableOpacity
                                    activeOpacity={0.7}
                                    onPress={() => {
                                        this.setState({selectedChip: item.status,selectedChipName: item.name}, () => {
                                            this.getUserOrders()
                                        })
                                    }}
                                    style={[Styles.row,Styles.br15,Styles.padH5,Styles.padV5,Styles.marV10,{
                                                    ...
                                                    <View style={[Styles.row,Styles.jSpaceBet,Styles.padH5,Styles.pBtm5,Styles.brdrBtm1,{borderBottomColor: '#b2beb5'}]}>
...

                                                        {
                                                            list.status === "READY_FOR_PICKUP"
                                                                ...
                                                                :
                                                                (list.status === 'OUT_ON_ROAD') && list.address
                                                                    ?
                                                                    Services.returnRouteNavigation(list.address.location, 'deliveryInList')
                                                                    :
                                                                    null
                                                    ...
                                                    <View style={[Styles.mBtm5]}>
                                                        ...
                                                        <View
                                                            ...
                                                            <View style={[Styles.row, Styles.jSpaceBet]}>
                                                                ...
                                                                {
                                                                    Services.returnRouteNavigation(list.pickUpAddress.location, 'pickUp')
                                                                }
                                                            </View>
                                                        </View>
                                                    </View>
                                    ...
                                    <View>
                                            ...
                                            })}/>
                                        {
                                            this.state.errorRejectReason ?
                                                <Text style={[Styles.cRed,Styles.ffMregular,Styles.pLeft20,Styles.mBtm10]}>{this.state.errorRejectReason}</Text>
                                                :
                                                null
                                        }
                                    </View>
