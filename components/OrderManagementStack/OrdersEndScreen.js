...
export default class OrdersEndScreen extends React.Component {
    ...
    endOrder = () => {
        ...
        const {orderData,orderItems,latitude,longitude} =self.state;
    ...
    requestToRejectOrder(){
        ...
        self.setState({spinnerBool: true}, () => {
            Services.AuthHTTPRequest(apiURL, "POST", rejectionRequestBody, function (response) {
                if (response.status === 200) {
                                                        ...
                                                        <View style={[Styles.row,Styles.jSpaceBet]}>
                                                            <View style={[Styles.row]}>
                                                                <Text
                                                                    ...
                                                                    Address:</Text>
                                                                <MaterialCommunityIcons name={showDeliveryAddress?"chevron-up-circle" : "chevron-down-circle"}
                                                                                        size={24}
                                                                                        style={[Styles.alignCenter,Styles.marH10,Styles.marV3]}
