...
import {Appbar,Card, DefaultTheme,Searchbar} from "react-native-paper";
                                                        ...
                                                        <ScrollView style={[Styles.padH20]}>
                                                            ...
                                                            </View>
                                                            {
                                                                this.state.errorRoleValue ?
                                                                    <Text style={[Styles.cRed,Styles.ffMregular,Styles.pLeft20,Styles.mBtm10]}>{this.state.errorRoleValue}</Text>
                                                                    :
                                                                    null
                                                            }
                                                            ...
                                                            </View>
                                                            {
                                                                this.state.errorSiteValue ?
                                                                    <Text style={[Styles.cRed,Styles.ffMregular,Styles.pLeft20,Styles.mBtm10]}>{this.state.errorSiteValue}</Text>
                                                                    :
                                                                    null
                                                            }
                                                            ...
                                                            <View>
                                                                    ...
                                                                    })}/>
                                                                {
                                                                    this.state.errorAcceptReason ?
                                                                        <Text style={[Styles.cRed,Styles.ffMregular,Styles.pLeft20,Styles.mBtm10]}>{this.state.errorAcceptReason}</Text>
                                                                        :
                                                                        null
                                                                }
                                                            </View>
