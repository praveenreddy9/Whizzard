    ...
    setDateTimePicker = (event, date) => {
        ...
        if (event.type === "set") {
            ...
            if (this.state.pickerMode === 'time'){
                ...
                let StartTime= new Date(selectedTimestamp).getHours();
                let StartTimeMin= new Date(selectedTimestamp).getMinutes();

                let TotalStartTime = (StartTime * 60) + (StartTimeMin);
                this.setState({TotalStartTime,showDateTimepicker:false},()=>{
                    if (StartTime <= 9) {
                        this.setState({StartTime: "0" + StartTime})
                    } else {
                ...
                } else if (tempDate.getMonth() < new Date().getMonth()) {
                    Utils.dialogBox('Previous Dates cannot be selected', '')
                ...
                this.setState({shiftDate,showDateTimepicker:false});
            }
            ...
            <View style={[[Styles.flex1, Styles.bgWhite, {width: Dimensions.get('window').width}]]}>
                ...
                <ScrollView
                    ...
                    <View style={[Styles.mTop5]}>
                        ...
                        <TouchableOpacity
                            ...
                            onPress={() => {this.setState({pickerMode:'date',showDateTimepicker:true}) }}>
                    ...
                    <View style={[Styles.marV5]}>
                        ...
                        <Card style={[styles.shadowCard]}>
                            <Card.Title
                                        ...
                                        right={() => <Ionicons onPress={() => this.setState({pickerMode:'time',showDateTimepicker:true})}
                            ...
                            <View
                                ...
                                <ScrollView
                                    ...
                                    {this.state.plansList.length === 0 ?
                                        <Text style={[Styles.ffMbold,Styles.f18]}>No Plans has found for
                                            selected Site</Text>
                                        :
                                        <List.Section>
                ...
                <Card style={[Styles.footerUpdateButtonStyles]}>
                    <TouchableOpacity onPress={() => {
                        ...
                        <Text
                            style={[Styles.cWhite, Styles.f20, Styles.p10, Styles.aslCenter, Styles.ffMregular]}>ASSIGN
                            SHIFT</Text>
                    </TouchableOpacity>
                </Card>
