...
export default class HomeScreen extends React.Component {
    ...
    constructor(properties) {
        ...
        this.state = {
            ...
            appState: AppState.currentState,soundLoopCount:-1,canContinueSound:true,
        };
    ...
    emitSocketToStart(){
        ...
        Config.routes.SOCKET_URL.emit('requestToReceiveData',{phoneNumber:loggedInUserDetails.phoneNumber})
        this.initaliseSocket()
    }

    initaliseSocket(){
        Config.routes.SOCKET_URL.on('sendOrderPickupData', (data)=>{
            // this.playSound()
            this.playSoundPlayer()
        },(error)=>{
    ...
    emitSocketToStop(){
        const {loggedInUserDetails} =this.state;
        Config.routes.SOCKET_URL.emit('requestToDisconnectData',{phoneNumber:loggedInUserDetails.phoneNumber})
    }

    emitSocketToStartforSupervisor(){
        const {loggedInUserDetails} =this.state;
        Config.routes.SOCKET_URL.emit('requestToReceiveForOMSData',{phoneNumber:loggedInUserDetails.phoneNumber})
        this.initaliseSocketforSupervisor()
    }

    initaliseSocketforSupervisor(){
        Config.routes.SOCKET_URL.on('sendOrderPickupForOMSData', (data)=>{
            // this.playSound()
            this.playSoundPlayer()
        },(error)=>{
            console.log('error',error);
    ...
    emitSocketToStopforSupervisor(){
        const {loggedInUserDetails} =this.state;
        Config.routes.SOCKET_URL.emit('requestToDisconnectForOMSData',{phoneNumber:loggedInUserDetails.phoneNumber})
    }
...
// See notes below about preloading sounds within initialization code below.
        var whoosh = new Sound(soundFileName, Sound.MAIN_BUNDLE, (error) => {
            ...
            whoosh.play((success) => {
                // console.log('reached sound play inside')
                // if (success) {
    ...
    playSoundPlayer(){
        try {
            ...
            SoundPlayer.playSoundFile('praveen', 'mp3')
            // or play from url
            // SoundPlayer.playUrl('https://www.zedge.net/ringtone/a5c6fc44-b30b-322b-9176-47dfc1bea158')
        } catch (e) {
        ...
        this.setState({spinnerBool: true}, () => {
            Services.AuthHTTPRequest(getLoggedinUserDetails, "GET", body, function (response) {
                if (response.status === 200) {
                   ...
                   // if (currentShift){
                   //     if (currentShift.status === 'INIT' || currentShift.status === 'ATTENDANCE_MARKED' || currentShift.status === 'SHIFT_IN_PROGRESS' ){
                   ...
                   // }
                    ...
                    // if (loggedInUserDetails.role >= 15){
                    //     self.emitSocketToStartforSupervisor()
                    // }else {
                    //     self.emitSocketToStopforSupervisor()
                    // }
         ...
         return (
            <ScrollView
                ...
                <View key={index} style={[Styles.OrdersScreenCardshadow,Styles.bgWhite,Styles.br5]}>
                    <View style={[Styles.row, Styles.jSpaceBet, Styles.p10,{borderBottomWidth: 2,
                ...
                style={[Styles.mTop10,]}>
                {
                    item.shiftActive === false
                        ...
                        <View key={index} style={[Styles.OrdersScreenCardshadow,Styles.bgLBlueMix,Styles.br5]}>
                            <View
                                style={[Styles.row, Styles.jSpaceBet,Styles.p10, {borderColor: '#f1f5f4',borderBottomWidth:2}]}>
                                <CText
                                    cStyle={[Styles.aslCenter, Styles.ffMbold]}>{new Date(item.shiftDate).toLocaleDateString()}</CText>
                                <CText
    ...
    returnSocketButtons(){
        ...
        return(
            <View style={[Styles.row,Styles.jSpaceBet,Styles.flexWrap]}>
                ...
                {/*<TouchableOpacity*/}
                {/*    onPress={()=>{*/}
                {/*        this.setState({canContinueSound:true},()=>{*/}
                {/*            // this.playSound()*/}
                {/*            this.playSoundPlayer()*/}
                {/*        })*/}
                {/*    }}*/}
                ...
                {/*<TouchableOpacity*/}
                {/*    onPress={()=>{*/}
                {/*        this.setState({canContinueSound:false})*/}
                {/*    }}*/}
                {/*    activeOpacity={0.7}*/}
                {/*    style={[Styles.OrdersScreenCardshadow, Styles.m10, Styles.br10, Styles.bgLPink,Styles.width120]}>*/}
                {/*    <View style={[Styles.alignCenter, Styles.p5]}>*/}
                {/*        <Text*/}
                {/*            style={[Styles.colorBlue, Styles.f14, Styles.ffMbold,]}>Stop Sound</Text>*/}
                {/*    </View>*/}
                {/*</TouchableOpacity>*/}
                ...
                <TouchableOpacity
                    ...
                    <View style={[Styles.alignCenter, Styles.p5]}>
                        <Text
                            style={[Styles.colorBlue, Styles.f14, Styles.ffMbold,]}>Initialise</Text>
                    </View>
                </TouchableOpacity>

                <TouchableOpacity
                    onPress={()=>{
                        Config.routes.SOCKET_URL.connect()
                    }}
                    activeOpacity={0.9}
                ...
                <TouchableOpacity
                    onPress={()=>{
                        Config.routes.SOCKET_URL.disconnect()
                    }}
                    activeOpacity={0.9}
                                            ...
                                            <Row size={12} style={[{marginBottom: 10}]}>
                                                <Col sm={4}>
                                                    <View
                                                        ...
                                                        <Image style={[Styles.aslCenter,Styles.img60,Styles.ImgResizeModeContain]} source={LoadImages.distance}/>
                                                        <Text
                                                ...
                                                <Col sm={4}>
                                                        <TouchableOpacity
                                                            ...
                                                            style={[Styles.alignCenter,Styles.OrdersScreenCardshadow,Styles.bgWhite,Styles.pBtm10,Styles.br5,{width:winWidth/3.2}]}>
                                                            <Image style={[Styles.aslCenter,Styles.img60,Styles.ImgResizeModeContain]} source={LoadImages.deliveries}/>
                                                            <Text style={[Styles.cBlk, Styles.f18, Styles.aslCenter, Styles.padV5, Styles.ffMbold]}>{loggedInUserDetails.totalDeliveries}</Text>
                                                            <Text style={[Styles.aslCenter, Styles.ffMbold]}>PACKAGES</Text>
                                                        </TouchableOpacity>
                                                </Col>
                                                <Col sm={4}>
                                                        <TouchableOpacity
                                                            ...
                                                            onPress={() => this.props.navigation.navigate('MyTrips', {shiftId: ''})}
                                                            style={[Styles.alignCenter,Styles.OrdersScreenCardshadow,Styles.bgWhite,Styles.pBtm10,Styles.br5,{width:winWidth/3.2}]}>
                                                            <Image style={[Styles.aslCenter,Styles.ImgResizeModeContain, {
                                                                height: 40,
                                                                width: 60,
                                                                margin: 10
                                                ...
                                                {/* DATE,ACTUAL AND REPORTING TIME CONDITIONS */}
                                                {
                                                    this.state.currentShift
                                                        ...
                                                        <View
                                                            ...
                                                            <View style={[Styles.row, Styles.jSpaceBet,Styles.padV5,{borderBottomWidth: 2,
                                                                borderBottomColor: '#e8eff9',}]}>
                                                                {
                                                                    this.state.currentShift === null
                                                                        ...
                                                                        null
                                                                        :
                                                                        <Text style={[Styles.aslCenter, Styles.ffMbold]}>{this.state.currentShift.shiftDateStr}</Text>
                                                                }
