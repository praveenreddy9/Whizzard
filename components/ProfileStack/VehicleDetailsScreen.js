...
import {
    ...
    Dimensions,
    TouchableOpacity,
    TextInput, Image, ActivityIndicator, Keyboard, Alert
} from "react-native";
                                                        ...
                                                        <View>
                                                            ...
                                                            </TouchableOpacity>
                                                            {
                                                                this.state.errorInsuranceMessage ?
                                                                    <Text style={[Styles.cRed,Styles.ffMregular,Styles.pLeft20,Styles.mBtm5]}>{this.state.errorInsuranceMessage}</Text>
                                                                    :
                                                                    null
                                                            }
                                                        </View>
                                                            ...
                                                            <View>
                                                                ...
                                                                </TouchableOpacity>
                                                                {
                                                                    this.state.errorPollutionMessage ?
                                                                        <Text style={[Styles.cRed,Styles.ffMregular,Styles.pLeft20,Styles.mBtm5]}>{this.state.errorPollutionMessage}</Text>
                                                                        :
                                                                        null
                                                                }
                                                            </View>
                                                            ...
                                                            <View>
                                                                ...
                                                                </TouchableOpacity>
                                                                {
                                                                    this.state.errorRoadTaxMessage ?
                                                                        <Text style={[Styles.cRed,Styles.ffMregular,Styles.pLeft20,Styles.mBtm5]}>{this.state.errorRoadTaxMessage}</Text>
                                                                        :
                                                                        null
                                                                }
                                                            </View>
                                                                ...
                                                                <View>
                                                                    ...
                                                                    </View>
                                                                    {
                                                                        this.state.errorVehicleRegMessage ?
                                                                            <Text style={[Styles.cRed,Styles.ffMregular,Styles.pLeft20,Styles.mBtm5]}>{this.state.errorVehicleRegMessage}</Text>
                                                                            :
                                                                            null
                                                                    }
                                                                </View>
                                                                ...
                                                                <View>
                                                                    ...
                                                                    </View>
                                                                    {
                                                                        this.state.errorVehicleTypeMessage ?
                                                                            <Text style={[Styles.cRed,Styles.ffMregular,Styles.pLeft20,Styles.mBtm5]}>{this.state.errorVehicleTypeMessage}</Text>
                                                                            :
                                                                            null
                                                                    }
                                                                </View>
                                                                ...
                                                                <View>
                                                                    ...
                                                                    </View>
                                                                    {
                                                                        this.state.errorVehicleModalMessage ?
                                                                            <Text style={[Styles.cRed,Styles.ffMregular,Styles.pLeft20,Styles.mBtm5]}>{this.state.errorVehicleModalMessage}</Text>
                                                                            :
                                                                            null
                                                                    }
                                                                </View>
