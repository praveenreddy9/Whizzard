...
import {
    ...
    Dimensions,
    TouchableOpacity,
    TextInput, Keyboard, Image, ActivityIndicator, Platform
} from "react-native";
    ...
    constructor(props) {
        ...
        this.state = {
            ...
            listOfStates: [
                ...
                {value: "Chandigarh", valueName: "Chandigarh"},
                ...
                {value: "West Bengal", valueName: "West Bengal"},
                                            ...
                                            <View style={{paddingLeft: 40}}>
                                                ...
                                                />
                                                {
                                                    this.state.errorAdharNameMessage ?
                                                        <Text style={[Styles.cRed,Styles.ffMregular,Styles.mBtm5]}>{this.state.errorAdharNameMessage}</Text>
                                                        :
                                                        null
                                                }
                                            </View>
                                            ...
                                            <View style={{paddingLeft: 40}}>
                                                ...
                                                />
                                                {
                                                    this.state.errorAdharCardMessage ?
                                                        <Text style={[Styles.cRed,Styles.ffMregular,Styles.mBtm5]}>{this.state.errorAdharCardMessage}</Text>
                                                        :
                                                        null
                                                }
                                            </View>
                                            ...
                                            <View style={{paddingLeft: 40}}>
                                                ...
                                                />
                                                {
                                                    this.state.errorPanNameMessage ?
                                                        <Text style={[Styles.cRed,Styles.ffMregular,Styles.mBtm5]}>{this.state.errorPanNameMessage}</Text>
                                                        :
                                                        null
                                                }
                                            </View>
                                            ...
                                            <View style={{paddingLeft: 40}}>
                                                ...
                                                />
                                                {
                                                    this.state.errorPanMessage ?
                                                        <Text style={[Styles.cRed,Styles.ffMregular,Styles.mBtm5]}>{this.state.errorPanMessage}</Text>
                                                        :
                                                        null
                                                }
                                            </View>
