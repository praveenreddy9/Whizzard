...
export class ReimbursementExpenses extends Component {
    ...
    createExpenseRequest() {
        ...
        // for (var i = 0; i < 4; i++) {
        //     const photo = self.state.image;
        //     // formData.append('data'+i, {
        //     //    uri: photo.path,
        //     //     type: photo.mime,
        //     //     name: photo.path
        //     // });
        //     formData.append('data'+i,self.state.TestFormData)
        // }
        //
        // console.log('final formdata',formData);

        // let body = self.state.TestFormData
        let body = {}
    ...
    imageUpload(uploadType) {
        ...
        Services.checkImageUploadPermissions(uploadType, (response) => {
            ...
            // let TestFormData = response.formData
            // let userImageUrl = image.path
            //
            // console.log('TestFormData',TestFormData);
            //
            // self.setState({image,TestFormData})
                                    ...
                                    <View style={[Styles.mBtm10]}>
                                            ...
                                            })}/>
                                        {
                                            this.state.errorRejectReason ?
                                                <Text style={[Styles.cRed,Styles.ffMregular,Styles.pLeft20]}>{this.state.errorRejectReason}</Text>
                                                :
                                                null
                                        }
                                    </View>
