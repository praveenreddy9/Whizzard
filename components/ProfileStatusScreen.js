            ...
            <View style={[Styles.flex1, {backgroundColor: '#140a25',}]}>
                ...
                <View style={[Styles.flex1, {
                    ...
                    <View style={[Styles.padH10]}>
                        ...
                        <CText
                            cStyle={[Styles.f22, Styles.cWhite, Styles.marV5, Styles.txtAlignCen,Styles.ffMregular]}>Your
                            registration needs to be approved by Supervisor. </CText>
                        <CText cStyle={[Styles.f22, Styles.cWhite, Styles.txtAlignCen,Styles.ffMregular]}>Please,
                            update your
                            profile</CText>
                    </View>
