...
export default class CreateNonRegisteredAdhocShift extends React.Component {
    ...
    errorHandling(error) {
        const self = this;
        // console.log('errorHandling in Lite user shift', error, error.response);
        if (error.response) {
                    ...
                    <View>
                        ...
                        </View>
                        {
                            this.state.errorIFSCcode ?
                                <Text style={[Styles.cRed,Styles.ffMregular,Styles.pLeft30,Styles.mBtm5]}>{this.state.errorIFSCcode}</Text>
                                :
                    ...
                    <View>
                            ...
                            })}/>
                        {
                            this.state.errorBankName ?
                                <Text style={[Styles.cRed,Styles.ffMregular,Styles.pLeft20,Styles.mBtm10]}>{this.state.errorBankName}</Text>
                                :
                                null
                        }
                    </View>
                    ...
                    <View>
                            ...
                            })}/>
                        {
                            this.state.errorBankAccountNumber ?
                                <Text style={[Styles.cRed,Styles.ffMregular,Styles.pLeft20,Styles.mBtm10]}>{this.state.errorBankAccountNumber}</Text>
                                :
                                null
                        }
                    </View>
                    ...
                    <View>
                            ...
                            })}/>
                        {
                            this.state.errorVerifyBankAccountNumber ?
                                <Text style={[Styles.cRed,Styles.ffMregular,Styles.pLeft20,Styles.mBtm10]}>{this.state.errorVerifyBankAccountNumber}</Text>
                                :
                                null
                        }
                    </View>
                        ...
                        <View style={{paddingLeft: 40}}>
                            ...
                            />
                            {
                                this.state.userErrorPanMessage ?
                                    <Text style={[Styles.cRed,Styles.ffMregular,Styles.pLeft20,Styles.mBtm10]}>{this.state.userErrorPanMessage}</Text>
                                    :
                                    null
                            }
                        </View>
                    ...
                    <View>
                            ...
                            })}/>
                        {
                            this.state.errorAccountHolderName ?
                                <Text style={[Styles.cRed,Styles.ffMregular,Styles.pLeft20,Styles.mBtm10]}>{this.state.errorAccountHolderName}</Text>
                                :
                                null
                        }
                    </View>
                            ...
                            <View style={{paddingLeft: 40}}>
                                ...
                                />
                                {
                                    this.state.errorPanMessage ?
                                        <Text style={[Styles.cRed,Styles.ffMregular,Styles.pLeft20,Styles.mBtm10]}>{this.state.errorPanMessage}</Text>
                                        :
                                        null
                                }
                            </View>
                        ...
                        <View>
                            ...
                            </View>
                            {
                                this.state.errorBeneficiaryIFSCcode ?
                                    <Text style={[Styles.cRed,Styles.ffMregular,Styles.pLeft30,Styles.mBtm5]}>{this.state.errorBeneficiaryIFSCcode}</Text>
                                    :
                            ...
                            <View style={{paddingLeft: 40}}>
                                    ...
                                    })}/>
                                {
                                    this.state.errorBeneficiaryName ?
                                        <Text style={[Styles.cRed,Styles.ffMregular,Styles.mBtm10]}>{this.state.errorBeneficiaryName}</Text>
                                        :
                                        null
                                }
                            </View>
                        ...
                        <View>
                                ...
                                })}/>
                            {
                                this.state.errorBeneficiaryAccountNumber ?
                                    <Text style={[Styles.cRed,Styles.ffMregular,Styles.pLeft20,Styles.mBtm10]}>{this.state.errorBeneficiaryAccountNumber}</Text>
                                    :
                                    null
                            }
                        </View>
                                                    ...
                                                    <View
                                                        ...
                                                        <RadioButton.Group
                                                            onValueChange={roleValue => this.setState({
                                                                ...
                                                                // if (userDetails.vehicleDetailsExists && userDetails.role === 10 && userDetails.vehicleType === '2'){
                                                                //     this.setState({
                                                                //         vehicleTypeValue:'',
                                                                //         vehicleTypeErrorMessage:'Role Change Not Accepted for created 2 Wheeler Vehicles'
                                                                //     })
                                                                // }else {
                                                                //     this.setState({
                                                                //         vehicleTypeErrorMessage:null
                                                                //     })
                                                                // }
                                                                    ...
                                                                    <View style={[Styles.row, Styles.aslCenter]}>
                                                                        {
                                                                            this.state.roleValue === 10 ?
                                                                                <View
                                                                                    ...
                                                                                    <RadioButton disabled={this.state.disableEnteringVehicleDetails} value={'2'}/>
                                                                                    <Image
                                                                        ...
                                                                        <View style={[Styles.row, Styles.alignCenter]}>
                                                                            <RadioButton disabled={this.state.disableEnteringVehicleDetails} value={'3'}/>
                                                                            <Image
                                                                                style={[Styles.aslCenter, {
                                                                                    height: 32,
                                                                                    width: 32
                                                                        ...
                                                                        <View style={[Styles.row, Styles.alignCenter]}>
                                                                            <RadioButton disabled={this.state.disableEnteringVehicleDetails} value={'4'}/>
                                                                            <Image
                                                                                style={[Styles.aslCenter, {
                                                                                    height: 32,
                                                                                    width: 32
